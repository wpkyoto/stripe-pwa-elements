import { r as registerInstance, f as createEvent, i as h, k as getElement } from './index-4a7881a4.js';
...
const stripeCardElementCss = "*:where(:not(iframe,canvas,img,svg,video):not(svg *)){all:unset;display:revert;background:none;border:none;font-family:\"Roboto\", suns-serif;box-sizing:border-box}:root{--color-label:#565656;--color-placeholder:#acacac;--color-heading-text:#333;--color-input-border:#e4e4e6;--color-button-text:rgba(255, 255, 255, 0.95);--color-button-text-disabled:rgba(255, 255, 255, 0.4);--color-primary:#0074d4}.stripe-payment-wrap{display:block;width:100%;background:#fff;padding:32px 16px}.StripeElement{padding:8px 16px;min-height:64px;border-bottom:1px solid var(--color-input-border);border-radius:4px;display:flex;justify-content:center;align-items:center}.StripeElement>.__PrivateStripeElement{width:100%}.stripe-input-box{background-color:#fff;border-radius:2px;filter:drop-shadow(0 0 1px var(--color-input-border))}.stripe-input-column .StripeElement{border-right:1px solid var(--color-input-border)}.stripe-input-column .StripeElement:last-child{border-right:none}.stripe-heading{font-size:24px;font-weight:bold;color:var(--color-heading-text);margin-bottom:24px}.stripe-section-title{font-size:14px;font-weight:bold;color:var(--color-label);margin-bottom:8px}.payment-info label{color:var(--color-label)}button{display:block;color:var(--color-button-text);background-color:var(--color-primary);width:100%;text-align:center;padding:16px 16px;font-size:18px;border-radius:8px;min-height:42px}button:disabled{color:var(--color-button-text-disabled)}";
...
const MyComponent = class {
   ...
   * @param param1
   */
  async defaultFormSubitAction(event, { stripe, cardNumber, paymentIntentClientSecret }) {
  ...
  async initElement() {
    ...
    document.getElementById('stripe-card-element').addEventListener('submit', async (e) => {
      ...
      const submitEventProps = { cardCVC, cardExpiry, cardNumber, stripe, paymentIntentClientSecret };
  ...
  render() {
    ...
    return (h("div", { class: "stripe-payment-wrap" }, h("form", { id: "stripe-card-element" }, h("div", { class: "stripe-heading" }, i18n.t('Add your payment information')), h("div", null, h("div", { class: "stripe-section-title" }, i18n.t('Card information'))), h("div", { class: "payment-info card visible" }, h("fieldset", { class: "stripe-input-box" }, h("div", null, h("label", null, this.showLabel ? h("lenged", null, i18n.t('Card Number')) : null, h("div", { id: "card-number" }))), h("div", { class: "stripe-input-column", style: { display: 'flex' } }, h("label", { style: { width: '50%' } }, this.showLabel ? h("lenged", null, i18n.t('MM / YY')) : null, h("div", { id: "card-expiry" })), h("label", { style: { width: '50%' } }, this.showLabel ? h("lenged", null, i18n.t('CVC')) : null, h("div", { id: "card-cvc" }))), h("div", { id: "card-errors", class: "element-errors" }, errorMessage))), h("div", { style: { marginTop: '32px' } }, h("button", { type: "submit", disabled: disabled }, this.progress === 'loading' ? i18n.t('Loading') : i18n.t('Pay'))))));
  }
  get el() { return getElement(this); }
};
MyComponent.style = stripeCardElementCss;

export { MyComponent as stripe_card_element };
