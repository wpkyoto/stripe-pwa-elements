...
declare global {
  ...
  interface HTMLStripeExpressCheckoutElementElement extends Components.StripeExpressCheckoutElement, HTMLStencilElement {
    addEventListener<K extends keyof HTMLStripeExpressCheckoutElementElementEventMap>(
      type: K,
      listener: (this: HTMLStripeExpressCheckoutElementElement, ev: StripeExpressCheckoutElementCustomEvent<HTMLStripeExpressCheckoutElementElementEventMap[K]>) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(type: K, listener: (this: Document, ev: DocumentEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
    addEventListener<K extends keyof HTMLElementEventMap>(
    ...
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof HTMLStripeExpressCheckoutElementElementEventMap>(
      type: K,
      listener: (this: HTMLStripeExpressCheckoutElementElement, ev: StripeExpressCheckoutElementCustomEvent<HTMLStripeExpressCheckoutElementElementEventMap[K]>) => any,
      options?: boolean | EventListenerOptions,
    ): void;
